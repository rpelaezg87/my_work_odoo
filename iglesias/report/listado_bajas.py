...
class ReportListadoBajas(models.AbstractModel):
    _name = 'report.iglesias.report_listado_bajas'

    def _get_miembross_con_bajas(self, congregaciones, fecha1, fecha2):
        dom = [('es_miembro', '=', True), ('fecha_baja', '>=', fecha1), ('fecha_baja', '<=', fecha2)]
        if congregaciones:
    ...
    def _get_result(self, congregaciones, fecha1, fecha2):
        result = {}
        miembros = self._get_miembross_con_bajas(congregaciones, fecha1, fecha2)
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('iglesias.report_listado_bajas', docargs)
